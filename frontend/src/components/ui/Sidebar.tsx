...
export function Sidebar({ children }: SidebarProps) {
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div
        className={cn(
          "bg-gradient-to-b from-slate-900 to-slate-800 shadow-2xl transition-all duration-300 ease-in-out border-r border-slate-700/50",
      ...
      >
        <div className="flex h-full flex-col">
          {/* Enhanced Logo */}
          <div className="flex h-14 sm:h-16 items-center justify-between px-4 border-b border-slate-700/50 bg-gradient-to-r from-blue-600 to-purple-600">
            {(sidebarOpen || isLargeScreen) ? (
      ...
      <div className="flex-1 flex flex-col overflow-hidden lg:ml-0">
        ...
        <header className="bg-gradient-to-r from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="flex items-center justify-between h-14 sm:h-16 px-4 sm:px-6">
            ...
            <button
              onClick={toggleSidebar}
              className="lg:hidden text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white p-2 rounded-md"
              ref={toggleBtnRef}
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
          {children}
        </main>
      </div>
    </div>
